...
void VectorDerivativeEstimator::initialize(int stateSizeInit)
{
	...
	RR.block(stateSize,stateSize,stateSize,stateSize) = 100000.0*R;
	P.block(0,0,stateSize,stateSize) = R;//covariance
	Q.block(0,0,stateSize,stateSize) =  10.0*Eigen::MatrixXf::Identity(stateSize,stateSize);//process covariance
