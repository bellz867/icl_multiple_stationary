...
KeyframePlanes::KeyframePlanes(float minareaInit, float maxareaInit, float minheightInit, float maxheightInit, int keyIndInit, int planeIndInit, std::vector<geometry_msgs::Point32>& planePointsInit, std::vector<uint8_t>& planeColorsInit, int rows, int cols)
{
  minarea = minareaInit;
  maxarea = maxareaInit;
...
void KeyframePlanes::update(int planeIndInd, std::vector<geometry_msgs::Point32>& planePointsInit, std::vector<uint8_t>& planeColorsInit, int rows, int cols)
{
  ...
  planesPoints.at(planeIndInd) = planePoints;
